		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 wow fadeInRight" >
					...
					<div class="skill-box wow fadeInDown" data-wow-delay=".10s">
						<label> Python</label>
						<div class="progress">
							<div class="progress-bar" role="progress-bar" aria-valuemin="0" aria-valuenow="85" aria-valuemax="100" style="width: 85%;" >
								85%
					...
					<div class="skill-box wow fadeInDown" data-wow-delay=".12s">
						<label> CPP</label>
						<div class="progress">
					...
					<div class="skill-box wow fadeInDown" data-wow-delay=".14s">
						<label> Java</label>
						<div class="progress">
					...
					<div class="skill-box wow fadeInDown" data-wow-delay=".16s">
